...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-50 dark:bg-[#0A1220] border-t border-eco-sage/20 pt-16 pb-8">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/privacy" className="text-sm text-eco-mint dark:text-eco-sage hover:text-eco-forest dark:hover:text-white transition-colors">Privacy Policy</a></li>
              <li><a href="/terms" className="text-sm text-eco-mint dark:text-eco-sage hover:text-eco-forest dark:hover:text-white transition-colors">Terms & Conditions</a></li>
              <li><a href="/faq" className="text-sm text-eco-mint dark:text-eco-sage hover:text-eco-forest dark:hover:text-white transition-colors">FAQ</a></li>
            </ul>
          </div>
