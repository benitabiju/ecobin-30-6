...
function FieldLabel({ children }) {
 return (
 <label className="block text-xs uppercase font-bold tracking-wider mb-1 text-primary">
 {children}
 </label>
 );
}
...
export default function Contact() {
 ...
 return (
 <motion.div initial="hidden" animate="visible" variants={{ visible: { transition: { staggerChildren: 0.1 } } }} className="text-primary">
 ...
 <div>
 <span className="inline-block text-xs uppercase tracking-widest font-bold text-secondary bg-eco-forest/10 dark:bg-eco-forest border border-eco-sage/20 px-4 py-1.5 rounded-full mb-5">
 Get in touch
 </span>
 <h2 className="font-display text-5xl md:text-6xl font-bold text-primary leading-tight">
 Let's build a<br />
 <span className="text-secondary">cleaner city</span><br />
 together.
 </h2>
 <p className="text-secondary mt-5 text-base leading-relaxed max-w-sm">
 ...
 <div className="font-display text-2xl font-bold text-secondary">{num}</div>
 <div className="text-xs uppercase tracking-wider text-muted mt-0.5">{lbl}</div>
 </div>
 ))}
 </div>
 </div>
 ...
 <div
 key={c.title}
 className="flex items-start gap-4 p-5 card-modern hover:border-eco-emerald/50"
 >
 <div className="w-10 h-10 rounded-xl bg-white dark:bg-eco-forest border border-eco-sage/20 flex items-center justify-center text-lg shrink-0 shadow-sm">
 {c.icon}
 </div>
 <div>
 <div className="text-sm font-bold text-primary">{c.title}</div>
 <div className="text-sm text-secondary mt-0.5">{c.value}</div>
 <span className="inline-block text-[10px] uppercase tracking-wider font-bold bg-eco-forest/10 dark:bg-eco-forest text-secondary border border-eco-sage/20 px-2.5 py-0.5 rounded-full mt-2">
 {c.badge}
 </span>
 </div>
 </div>
 ...
 <span className="text-xs uppercase tracking-widest text-muted">Send us a message</span>
 <div className="flex-1 h-px bg-eco-sage/20 dark:bg-eco-sage/10" />
 </div>
 ...
 activeTab === i
 ? "text-secondary border-eco-emerald"
 ...
 <div className="text-xs text-secondary mt-1.5 leading-relaxed">{r.desc}</div>
 </div>
 ))}
 </div>
 </motion.div>
 ...
 <div
 key={t.name}
 className="shrink-0 w-80 p-6 card-modern"
 >
 <Stars count={t.stars} />
 <p className="text-sm text-secondary leading-relaxed font-medium">"{t.quote}"</p>
 <div className="flex items-center gap-3 mt-6">
 <div className="w-10 h-10 rounded-full bg-eco-forest/10 dark:bg-eco-forest border border-eco-emerald/20 flex items-center justify-center text-xs font-bold text-secondary shrink-0 shadow-inner">
 {t.initials}
 </div>
 <div>
 ...
 <div>
 <h3 className="font-display text-2xl font-bold text-primary mb-3">Our offices</h3>
 ...
 <span className="text-primary font-semibold">{o.label}</span> — {o.sub}
 </div>
 </div>
 ))}
 </div>
