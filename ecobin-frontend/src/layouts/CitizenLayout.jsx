...
export default function CitizenLayout({ handleLogout, theme, toggleTheme }) {
 ...
 <span className="font-display font-bold text-primary dark:text-emerald-400 hidden sm:block">Citizen Portal</span>
 </div>
 ...
 <div className="w-8 h-8 rounded-full bg-eco-sage dark:bg-eco-forest flex items-center justify-center text-primary text-xs font-bold uppercase">
